...
using DocumentSign_API.Models;
using DocumentSign_API.Providers;
using DocumentSign_API.Results;
using DocumentSign_BusinessLayer;
using DocumentSign_Models.TableModels;

namespace DocumentSign_API.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            //    userProfile.AspNetUserId = result.
            //    repo.SaveEditUserProfile(userProfile);
            //}
        ...
        public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                emailRepo.SendEmail(user.Email, "Document Sign System Reset Password",
                    "Password Reset", $"Please reset your password by using this code: {code}");
